...
if HttpRequest ~= nil and identifyexecutor and check_url(webhook) then
    local game_name = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name or "Nil"
    local data = {
        ["content"] = "",
        ["embeds"] = {{
            ...
            ["fields"] = {
                ...
                {["name"] = "Game:", ["value"] = tostring(" %s | **[Link](https://www.roblox.com/games/%s)**"):format(tostring(game_name,game.PlaceId))},
